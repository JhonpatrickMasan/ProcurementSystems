...
<head>
    ...
    <style>
        ...
        #userSection {
            margin-bottom: 20px; /* Added margin below the user information */
        }
        ...
        #userName {
            color: #fff;
            font-weight: bold;
            margin-top: 5px; /* Adjusted margin above the user's name */
        }

        #welcomeText {
            color: #fff;
            margin-top: 5px; /* Adjusted margin above the welcome text */
        }
