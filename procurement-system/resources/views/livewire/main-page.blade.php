    ...
    <div class="full-background">
        <div style="background-color: rgba(255, 255, 255, 0.8); padding: 40px; border-radius: 10px; position: relative; text-align: center; width: 400px;">
            ...
            <div class="blue-button-container" style="margin-top: 10px;">
                ...
                <button wire:click="navigateToSignIn" class="btn btn-primary" style="background-color: #007bff; color: white; padding: 15px 40px; border-radius: 30px; margin-bottom: 20px; font-weight: bold; border: none;">Current Supplier</button>
            </div>
        </div>
    </div>
</x-layouts.app>
